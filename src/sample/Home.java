...
public class Home {
    ...
    @FXML
    void HomeItself(ActionEvent event) throws IOException {
    ...
    void initialize() {
        ...
        assert contest != null : "fx:id=\"contest\" was not injected: check your FXML file 'Home.fxml'.";
        assert problemset != null : "fx:id=\"problemset\" was not injected: check your FXML file 'Home.fxml'.";
        assert discussion != null : "fx:id=\"discussion\" was not injected: check your FXML file 'Home.fxml'.";
        assert profile != null : "fx:id=\"profile\" was not injected: check your FXML file 'Home.fxml'.";
        assert signOut != null : "fx:id=\"signOut\" was not injected: check your FXML file 'Home.fxml'.";
